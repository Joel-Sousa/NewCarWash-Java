...
import com.example.carwash.adapter.Administrador.RecyclerViewAdapterVeiculo;
...
public class ListagemVeiculo extends AppCompatActivity {

    TextView textViewUsuario;
    ImageView imageViewVoltar, imageViewCheck;
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView textViewUsuario = findViewById(R.id.textViewListagemVeiculoUsuario);
        textViewUsuario.setText(MainActivity.usuarioB);

        imageViewVoltar = findViewById(R.id.imageViewListaVeiculosVoltar);
        context = getApplicationContext();
        recyclerView = (RecyclerView) findViewById(R.id.recyclerViewVeiculo);
    ...
    private void listar() {
        ...
        recyclerViewAdapter = new RecyclerViewAdapterVeiculo(context, dados_ids, dados_veiculos,
