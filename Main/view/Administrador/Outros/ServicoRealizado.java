...
import com.example.carwash.adapter.Administrador.RecyclerViewAdapterServicoRealizado;
...
public class ServicoRealizado extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_servico_realizado);

        TextView textViewUsuario = findViewById(R.id.textViewServicoRealizadoUsuario);
        textViewUsuario.setText(MainActivity.usuarioB);

//        Intent intent = getIntent();
//        textViewUsuario = findViewById(R.id.textViewListagemVeiculoUsuario);
//        textViewUsuario.setText(intent.getStringExtra("usuario"));

        imageViewVoltar = findViewById(R.id.imageViewServicoRealizadoVoltar);
        context = getApplicationContext();
        recyclerView = (RecyclerView) findViewById(R.id.recyclerViewServicoRealizado);
    ...
    private void listar() {
        ...
        recyclerViewAdapter = new RecyclerViewAdapterServicoRealizado(context, dados_ids, dados_veiculos,
